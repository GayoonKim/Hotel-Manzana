...
class RegistrationTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "registrationDetail" {
            ...
            let addRegistrationTableViewController = navigationViewController?.topViewController as? AddRegistrationTableViewController
            addRegistrationTableViewController?.selectedRegistration = registrations[selectedIndexPath.row]
            addRegistrationTableViewController?.roomType = registrations[selectedIndexPath.row].roomType
        }
